...
// Capturamos el rol de la sesión para usarlo de forma cómoda en las condiciones de abajo
...
<body>
	<div class="wrapper">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										<div class="dropdown-item" style="cursor: pointer;" onclick="window.location.href='index.php'">Salir</div>
									</li>
								</div>
							</ul>
						</li>
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<?php if ($rol_actual === 'admin' || $rol_actual === 'admision'): ?>
							...
							<li class="nav-item">
								<a href="#" class="nav-link enlace-navegacion" data-view="arqueos">
							...
							<li class="nav-section">
								...
								<h4 class="text-section">Reportes citas </h4>
							</li>
						...
						<?php if ($rol_actual === 'admin' || $rol_actual === 'medico' || $rol_actual === 'admision'): ?>
							<li class="nav-section">
								<span class="sidebar-mini-icon">
									<i class="fa fa-folder-open"></i>
								</span>
								<h4 class="text-section">Área Médica</h4>
							</li>

							<li class="nav-item <?= ($rol_actual === 'medico') ? 'active' : ''; ?>">
								<a href="#" class="nav-link enlace-navegacion" data-view="historias_clinicas">
		...
		<div class="main-panel">
			<div class="content" id="contenedor-central">
				<?php
				// Si es médico, lo mandamos directo a las historias clínicas al entrar, si no, al dashboard común
	...
	<script>
		// Compartimos el rol de PHP a JavaScript de forma segura para usarlo en vistas hijas si es necesario
		const ROL_USUARIO = "<?= $rol_actual; ?>";
